...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "7bd95c59f45fc651b843d3d536ed64bc6580cb22";
    public List<Set<String>> extract(List<String> articles) {
        ...
        ResponseHandler<List<Set<String>>> responseHandler = new ResponseHandler<List<Set<String>>>() {
            @Override
            public List<Set<String>> handleResponse(HttpResponse response) throws ClientProtocolException, IOException {
